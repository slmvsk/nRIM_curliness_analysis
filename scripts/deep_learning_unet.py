# -*- coding: utf-8 -*-
"""Deep_learning_Unet.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13bkCVJY5wfKpgX9Tv36jkoAap_7rF3uo
"""

#This code uses 3D Unet to train a network on 3D subvolumes.
...
#Latest Tensorflow (2.4) can give errors for some of the libraries used,
...
plt.imshow(img_patches[0,1,2,2,:])
#plt.imshow(mask_patches[0,1,2,2,:])
...
X_train, X_test, y_train, y_test = train_test_split(train_img, train_mask_cat, test_size = 0.15, random_state = 0)
...
patches = patchify(large_image, (256, 256, 5), step=256)  #Step=256 for 256 patches means no overlap
...
io.write_ometiff("....ome.tiff", final)